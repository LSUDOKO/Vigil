...
import { WIGGLE_CONFIG } from '@/lib/landing-data';
                ...
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            ...
                            <span className="logo-work-text">docs</span>
                        </div>
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=800&auto=format&fit=crop" loading="eager" alt="Declared intent compiled into a policy" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">intent policy</span>
                                        <h4 className="nav-work-title">declared intent, enforced</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop" loading="eager" alt="Cost forecast projecting a budget breach" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">cost firewall</span>
                                        <h4 className="nav-work-title">projected breach, rerouted</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=800&auto=format&fit=crop" loading="eager" alt="A verified tamper-evident audit chain" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">audit chain</span>
                                        <h4 className="nav-work-title">tamper-evident by design</h4>
                                    </div>
                                </div>
                                <a href="#" className="nav-work-btn"><span className="nav-work-btn__text">Read the docs</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">connect an agent</h4>
                                <p className="nav-wa-desc">Point any MCP client at Vigil and every tool call is governed.</p>
                                <a href="#" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Connection guide</span>
